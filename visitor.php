              ...
              <div id="Div1" style="display: block;">
                ...
                <tr>
                  <td >
                      ...
                      <tr ><td align="left"><input type="radio" name="session" value="Pickup" disabled/> <span style="text-decoration: line-through;">Pickup</span> <sup>*</sup> </td></tr>
                      <tr><td align="left"><input type="radio" name="session" value="Pickup and Drop off" disabled/> <span style="text-decoration: line-through;">Pickup and Drop off</span> <sup>*</sup></td></tr>
                      
                      <tr><td align="left"><input type="radio" name="session"  value="Self-Service" > Self-Service </input></td></tr>
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    ...
                    <tr ><td align="left"><input type="checkbox" name="service1" value="Washer and Dryer"> Washer and Dryer </td></tr>
                      ...
                      <tr><td align="left"><input type="checkbox" name="service3" value="Iron and Fold" disabled> Iron and Fold </td></tr>
                      <tr><td align="left"><input type="checkbox" name="service4" value="Leather, fur & suede" disabled> Leather, fur & suede </td></tr>
                ...
                <tr>
                  <td>
                    <tr><td>Date</td></tr>
                    <tr ><td align="left"><input type="Text" onfocus="(this.type = 'date')" style="background:transparent ;width:100%;" onfocusout="(this.type = 'Text')"  name="dateT" placeholder="Session Date" required ></td></tr>
                    <tr><td align="left"><sup>*</sup> = <span style="color:orange;font-size:18px"> (Become a premium member @99.99$ only) </span></td></tr>
                  </td>
                </tr>
                <tr>
                  <td>
